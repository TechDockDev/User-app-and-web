            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      SizedBox(height: 5),
                      Text(
                        '${PriceConverter.convertPrice(_startingPrice, discount: _discount, discountType: _discountType,asFixed: 0)}'
                            '${_endingPrice != null ? ' - ${PriceConverter.convertPrice(_endingPrice, discount: _discount,
                            discountType: _discountType,asFixed: 0)}' : ''}',
                        style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                      ),
                      SizedBox(height: 5),
                      price > priceWithDiscount ? Text(
                        '${PriceConverter.convertPrice(_startingPrice,asFixed: 0)}'
                            '${_endingPrice != null ? ' - ${PriceConverter.convertPrice(_endingPrice,asFixed: 0)}' : ''}',
                          ...
                          child: Column(children: [
                            Expanded(
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                SizedBox(height: 5),
                                Text(
                                  product.addOns[index].price > 0 ? PriceConverter.convertPrice(product.addOns[index].price,asFixed: 0) : 'free'.tr,
                ...
                Row(children: [
                  ...
                  Text(PriceConverter.convertPrice(priceWithAddons,asFixed: 0), style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
                ]),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
