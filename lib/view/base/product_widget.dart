...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool _isAvailable;
    //inRestaurant ? print('true $inRestaurant') : print('false $inRestaurant');
    if(isRestaurant) {
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(
                    ...
                    style: robotoMedium.copyWith(fontSize: isRestaurant ? Dimensions.fontSizeLarge : Dimensions.fontSizeDefault ),
                  ...
                  SizedBox(height: (_desktop ) ? 3 : 0),

                  !isRestaurant ?  !inRestaurant ? RatingBar(
                    rating: isRestaurant ? restaurant.avgRating : product.avgRating, size: _desktop ? 16 : 14,
                    ratingCount: isRestaurant ? restaurant.ratingCount : product.ratingCount,
                  ) :  SizedBox():SizedBox(),
                  SizedBox(height: (!isRestaurant && _desktop) ? Dimensions.PADDING_SIZE_SMALL : 0),

                  isRestaurant ? RatingBar(
                    rating: isRestaurant ? restaurant.avgRating : product.avgRating, size: _desktop ? 16 : 12,
                    ratingCount: isRestaurant ? restaurant.ratingCount : product.ratingCount,
                  ): Row(children: [

                    Text(
                      PriceConverter.convertPrice(product.price, discount: _discount, discountType: _discountType, asFixed: 0),
                      style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault),
                    ),
                    SizedBox(width: _discount > 0 ? Dimensions.PADDING_SIZE_EXTRA_SMALL : 0),

                    _discount > 0 ? Text(
                      PriceConverter.convertPrice(product.price,asFixed: 0),
              ...
              Column(mainAxisAlignment: isRestaurant ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween, children: [
                ...
                !isRestaurant ? Padding(
                    padding: EdgeInsets.symmetric(vertical: _desktop ? Dimensions.PADDING_SIZE_SMALL : 0),
                    child:  Container(
                      child: new Text ("Add", style: robotoRegular.copyWith( fontSize: Dimensions.fontSizeSmall, color: Colors.black87,) ),
