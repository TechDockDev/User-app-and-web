                      ...
                      child: SizedBox(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(PriceConverter.convertPrice(_itemPrice,asFixed: 0), style: robotoRegular),
                          ]),
                          SizedBox(height: 10),

                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('addons'.tr, style: robotoRegular),
                            Text('(+) ${PriceConverter.convertPrice(_addOns,asFixed: 0)}', style: robotoRegular),
                          ]),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(PriceConverter.convertPrice(_subTotal,asFixed: 0), style: robotoMedium),
                          ]),
