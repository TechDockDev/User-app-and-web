                          ...
                          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                            Container(
                              ...
                              child: Text(orderList[index].orderStatus.tr, style: robotoMedium.copyWith(
                                fontSize: Dimensions.fontSizeExtraSmall, color: Colors.black87,
                              )),
                            ),
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                            isRunning ? InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(children: [
                                  Image.asset(Images.tracking, height: 15, width: 15, color: Colors.black54),
                                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  Text('track_order'.tr, style: robotoMedium.copyWith(
                                    fontSize: Dimensions.fontSizeExtraSmall, color: Colors.black54,
                                  )),
                                ]),
                              ),
                            ) : Text(
