...
class RestaurantDescriptionView extends StatelessWidget {
  ...
  RestaurantDescriptionView({@required this.restaurant,@required this.couponList});
    ...
    return Column(children: [
      Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(
            restaurant.name, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: _textColor),
            maxLines: 1, overflow: TextOverflow.ellipsis,
          ),
          SizedBox(height: ResponsiveHelper.isDesktop(context) ? 0  : Dimensions.PADDING_SIZE_EXTRA_SMALL),
          // Text(
