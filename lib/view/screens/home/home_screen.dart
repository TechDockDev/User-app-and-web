...
import 'package:efood_multivendor/view/screens/home/widget/offer_restaurant_view.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Future<void> _loadData(bool reload) async {
    ...
    await Get.find<RestaurantController>().getOfferRestaurantList(reload);
              ...
              SliverToBoxAdapter(
                child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  GetBuilder<RestaurantController>(builder: (restController) {
                    return restController.offerRestaurantList == null ? OfferRestaurantView(restController: restController,)
                        : restController.offerRestaurantList.length == 0 ? SizedBox() : OfferRestaurantView(restController: restController, );
                  }) ,
