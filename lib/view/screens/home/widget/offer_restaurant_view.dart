...
class OfferRestaurantView extends StatelessWidget {
  final RestaurantController restController;
  OfferRestaurantView({@required this.restController});

  @override
  Widget build(BuildContext context) {
    List<Restaurant> _restaurantList = restController.offerRestaurantList;
    ...
    return Column(
      children: [
        Padding(
          ...
          child: TitleWidget(
            title: 'new_offer'.tr ,
            onTap: () => Get.toNamed(RouteHelper.getAllRestaurantRoute('latest')),// onTap
          ),
        ),
                  ...
                  child: Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Stack(children: [
                        ...
                        _restaurantList[index].discount!=null?DiscountTag(
                          discount: _restaurantList[index].discount != null
                              ? _restaurantList[index].discount.discount : 0,
                          discountType: _restaurantList[index].discount.discountType!=null ? _restaurantList[index].discount.discountType :'free_delivery'  , freeDelivery: _restaurantList[index].freeDelivery, fontSize: Dimensions.PADDING_SIZE_DEFAULT,
                        ):SizedBox(),
