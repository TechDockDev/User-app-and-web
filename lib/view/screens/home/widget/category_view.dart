            ...
            Expanded(
              child: SizedBox(
                ...
                child: categoryController.categoryList != null ? ListView.builder(
                  ...
                  itemCount: categoryController.categoryList.length > 25 ? 25 : categoryController.categoryList.length,
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Text('view_all'.tr, style: TextStyle(fontSize: Dimensions.PADDING_SIZE_DEFAULT, color: Colors.black54)),
                    ),
                  ),
                ),
                SizedBox(height: 10,)
